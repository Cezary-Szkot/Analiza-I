...
\begin{defr}{Definicja 6.17: Równoważność metryk}
    ...
    \begin{enumerate}[label=\Roman*.]
        \item $\forall_{x,y\in X}\ \forall_{\delta>0}\ \exists_{\varepsilon>0}\hquad
        (d_1(x,y)<\varepsilon\implies d_2(x,y)<\delta)\ \land\ (d_2(x,y)<\varepsilon\implies d_1(x,y)<\delta$),
        \item $\forall_{x\in X}\ \forall_{\delta>0}\ \exists_{\varepsilon>0}\hquad
        B_1(x,\varepsilon)\subset B_2(x,\delta)\ \land\ B_2(x,\varepsilon)\subset B_1(x,\delta)$.
    \end{enumerate}
\end{defr}
