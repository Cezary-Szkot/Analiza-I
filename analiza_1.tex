...
Dane są przestrzenie metryczne $(X,d_X)$, $(Y,d_Y)$. Niech $A\subset X$, $g\in Y$, $f:A\to Y$ i $p\in\closure{A\setminus\set{p}}$.
Mówimy, że funkcja $f$ ma granicę $g$ w punkcie (skupienia) $p$, jeśli
\begin{enumerate}
